	...
	<div class="row" style="margin-top:20px;">
		<div class="col-md-4 col-md-offset-4">
			...
			<?php
				...
				echo form_open("/god_register/register_validation",$form_arr);	//フォームを開く
				...
				//2014/9/27
				echo '<p class="text-center" style="margin-top:10px;">OR</p>';
				echo '<a class="btn btn-default btn-block"  id="facebook_button" href="/gplogin/">';
				echo '<i class="icon-github"></i> Google+アカウントを使って登録';
				echo '</a>';
				//2014/9/27
				echo '<p class="text-center">';
				echo '<a href="/god/">すでにIDをお持ちですか?</a>';
				echo '</p>';
				echo '</fieldset>';
