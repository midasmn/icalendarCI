    ...
    <div class="row" style="margin-top:10px;">
        ...
        <div class="col-md-3">
            <div class="btn-group btn-group-justified">
                <a href="#" id="show-preview" class="active btn btn-default">キーワード</a>
                <a href="#" id="show-html" class="btn btn-default">スクレイピング</a>
            </div>
        </div>

        <div class="col-md-3">
            <input class="form-control" placeholder="キーワード" name="title" type="text">
        </div>

        <div class="col-md-3">
            <select class="form-control" name="bootstrap-version">
                <li class=" selected version-chooser">
                    <option selected value="google">Google画像</option>
                </li>
                <li class=" version-chooser">
                    <option value="fotolia">fotolia画像</option>   
                </li>       
            </select>
        </div>
